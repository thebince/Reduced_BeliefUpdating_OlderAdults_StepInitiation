...
%             % Instead of median line, compute mean for the current group & condition
%             mean_val = mean(Y(Gi==g, k));
%             % draw the mean line
%             h.md(k,g) = line(Xx(1,:), mean_val * ones(size(Xx(1,:))),...
%                 'color', mcol, 'LineWidth', 2);
